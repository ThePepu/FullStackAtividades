...
function Contato() {
  ...
  return (
    <section className="secao secao-clara" id="contato">
      <div className="container contato-grid">
        ...
        <form className="formulario" onSubmit={enviarFormulario}>
          ...
          <input id="contato" name="contato" type="text" placeholder="(00) 00000-0000 ou seu@email.com" required />

          <label htmlFor="mensagem">Mensagem inicial</label>
          <textarea id="mensagem" name="mensagem" rows="5" placeholder="Como posso ajudar você?" required></textarea>
